        ...
        <div class="flex-1">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div class="xl:col-span-1">
                    <div class="bg-white rounded-[2rem] shadow-[0_10px_30px_rgba(107,33,168,0.05)] border border-slate-200 p-6 lg:p-8 sticky top-[100px]">
                        ...
                        <form action="{{ route('admin.products.store') }}" method="POST" class="space-y-4">
                            ...
                            <button type="submit" class="w-full bg-[#1e1b4b] text-white py-3.5 rounded-xl font-black uppercase tracking-wider mt-4 hover:bg-esv-primary transition-all shadow-lg flex items-center justify-center gap-2 skew-x-[-5deg] group">
                            ...
                            <table class="w-full text-sm text-left whitespace-nowrap">
                                <thead class="bg-slate-50 text-slate-500 border-b border-slate-200">
                                    <tr class="uppercase tracking-wider text-[10px] font-black">
                                        <th class="px-4 py-4 rounded-tl-xl">รูป/ไอคอน</th>
                                        <th class="px-4 py-4">ข้อมูลสินค้า</th>
                                        <th class="px-4 py-4 text-center">สต๊อก</th>
                                        <th class="px-4 py-4 text-center">สถานะการขาย</th>
                                ...
                                <tbody class="divide-y divide-slate-100">
                                    ...
                                    <tr class="hover:bg-slate-50/50 transition-colors group">
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="font-black text-slate-800 text-base leading-tight mb-1">{{ $product->name }}</div>
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="flex flex-col gap-1 items-center">
                                                <span class="bg-blue-50 text-blue-600 px-2.5 py-1 rounded-md text-[10px] font-bold border border-blue-100 w-20 text-center">
                                                    ขาย: {{ $product->stock }}
                                                </span>
                                                <span class="bg-purple-50 text-purple-600 px-2.5 py-1 rounded-md text-[10px] font-bold border border-purple-100 w-20 text-center">
...
<script>
    function confirmDelete(id, name) {
        Swal.fire({
            title: 'ยืนยันการลบ?',
            html: `คุณแน่ใจหรือไม่ที่จะลบสินค้า <b>"${name}"</b>?<br><span class="text-rose-500 text-sm">*การลบจะไม่สามารถกู้คืนได้</span>`,
            icon: 'warning',
